...
> **Note**: Из-за этой логики таблица `profiles` больше не привязана внешним ключом к `auth.users`. Обновите базу с помощью миграции `20250719200000_fix_profiles_fk.sql`.
